...
func TestHalfAdder(t *testing.T) {
	h, err := hw.Chip("myHalfAdder", "a, b", "s, c",
...
func TestFullAdder(t *testing.T) {
	...
	adder, err := hw.Chip("myFullAdder", "a, b, cin", "s, cout",
		h("a=a, b=b, s=s0, c=c0"),
...
func TestAdderN(t *testing.T) {
	add4, err := hw.Chip("Adder4", "a[4], b[4]", "out[4], c",
...
func Test_adders(t *testing.T) {
	...
	add1, err := hw.Chip("1bitAdder", "a, b, c0", "s, g, p",
	...
	add4, err := hw.Chip("Adder4", "a[4], b[4], c0", "out[4], p, g",
	...
	add16, err := hw.Chip("Adder4", "a[16], b[16], c0", "out[16], p, g",
		lcu("p[0..3]=p[0..3], g[0..3]=g[0..3], c0=c0, p=p, g=g, c1=c1, c2=c2, c3=c3"),
	...
	wrap, err := hw.Chip("myAdder16", "a[16], b[16]", "out[16], c",
