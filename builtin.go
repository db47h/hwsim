...
//
func And(w string) PartWiring { return and.Wire(w) }

// Nand returns a NAND gate.
//
func Nand(w string) PartWiring { return nand.Wire(w) }

// Or returns a OR gate.
//
func Or(w string) PartWiring { return or.Wire(w) }

// Nor returns a NOR gate.
//
func Nor(w string) PartWiring { return nor.Wire(w) }

// Xor returns a XOR gate.
//
func Xor(w string) PartWiring { return xor.Wire(w) }

// Xnor returns a XNOR gate.
//
func Xnor(w string) PartWiring { return xnor.Wire(w) }
...
//
func Mux(w string) PartWiring { return mux.Wire(w) }
...
//
func DMux(w string) PartWiring { return dmux.Wire(w) }
...
//
func Not16(w string) PartWiring { return not16.Wire(w) }
...
//
func And16(w string) PartWiring { return and16.Wire(w) }
...
//	Function: for i := range out { out[i] = !(a[i] && b[i]) }
//
func Nand16(w string) PartWiring { return nand16.Wire(w) }
...
//	Function: for i := range out { out[i] = (a[i] || b[i]) }
//
func Or16(w string) PartWiring { return or16.Wire(w) }
...
//	Function: for i := range out { out[i] = !(a[i] || b[i]) }
//
func Nor16(w string) PartWiring { return nor16.Wire(w) }
